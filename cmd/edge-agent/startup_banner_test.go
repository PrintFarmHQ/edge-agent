...
func TestBuildStartupBannerIncludesDashboardPort(t *testing.T) {
	banner := buildStartupBanner(startupBannerInfo{
		DashboardURL:    "http://127.0.0.1:55189/",
		DashboardPort:   "55189",
		SetupURL:        "http://127.0.0.1:18090/",
	...
	if !strings.Contains(banner, "Port      55189") {
		t.Fatalf("banner missing port line: %q", banner)
	}
